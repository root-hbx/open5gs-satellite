...
#### UE address subnet
- Change default UE address subnet from 45.45.0.1/16 to 10.42.0.1/16 ([#369](https://github.com/open5gs/open5gs/pull/369)) -- [spencersevilla](https://github.com/spencersevilla)
